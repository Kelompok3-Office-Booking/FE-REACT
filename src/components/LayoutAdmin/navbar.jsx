        ...
        <div className="bg-slate-900 text-white flex justify-center">
            <div className="container">
                <nav className="flex justify-between my-4">
                    ...
                    <button id="dropdownDividerButton" data-dropdown-toggle="dropdownDivider" className="flex content-center bg-sky-800 rounded-full px-4 py-2">
                        <img src={twitter} alt="" className="w-12 border-4 rounded-full border-sky-700 my-auto" />
