  ...
  return (
    <div className={`bg-slate-900`}>
      <div className={`bg-white min-h-screen rounded-tr-[75px]`}>
        <div
          className={`${
            toggle ? "w-80 -translate-x-1" : "w-48 translate-x-0 "
