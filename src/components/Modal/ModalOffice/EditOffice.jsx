    ...
    <>
      <div className="flex flex-col w-full">
        <div className="flex justify-start px-8 py-4 w-full bg-white rounded-2xl shadow">
          ...
          <h1 className="text-2xl font-bold my-auto">Edit Office</h1>
        </div>
          ...
          <div className="mx-2 mt-4 mb-4 w-1/2">
            ...
            <div className="pb-6 w-full flex justify-between">
              <div className="w-full">
                <select
                  id="city"
                  onChange={(ev) => handleSelectedRegion(ev)}
                  class="border-2 py-3.5 border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                >
              ...
              <div className="w-full ml-8">
                ...
                >
                  ...
                  {district.map((val, index) => {
                    return (
                      <>
                        <option value={val} id="regionIndex" index={index}>
                          {val}
                        </option>
                      </>
                    );
