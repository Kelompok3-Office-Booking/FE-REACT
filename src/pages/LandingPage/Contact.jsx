...
import { faHouse, faPhone, faEnvelope, faCalendarDays, faPenToSquare } from "@fortawesome/free-solid-svg-icons";
import { Link } from "react-router-dom";

const Contact = () => {
    return (
        <div className="bg-gray-200 py-12 lg:py-24 flex justify-center">
            <div className="container flex flex-col lg:flex-row content-center">
                <div className="lg:w-1/2">
                    <div className="text-center lg:text-start">
                        ...
                        <p className="text-xl lg:w-3/4 py-4">give us suggestions and input to make it better in the future</p>
                    </div>
                    <div className="flex flex-col text-center lg:text-start">
                        <h3 className="font-bold text-xl 2xl:text-2xl my-8">We’d Love to hear from you</h3>
                        <div className="flex flex-col lg:flex-row content-center">
                            <div className="flex flex-col justify-center">
                                <img src={logo_black} alt="" className=" mb-4 px-12 w-full h-24 2xl:w-full lg:h-auto" />
                                <p className="text-black text-lg font-bold 2xl:text-xl">BETTER SPACE</p>
                            </div>
                            <div className="py-4 lg:py-1 lg:pl-4 2xl:pl-12">
                                <div className="flex py-2 items-center md:justify-center lg:justify-start">
                                    ...
                                    <p className="font-semibold 2xl:text-xl">Savana street 21, Jakarta</p>
                                </div>
                                ...
                                <div className="flex py-2 items-center md:justify-center lg:justify-start">
                                    ...
                                    <p className="font-semibold 2xl:text-xl"><Link>better.space@gmail.com</Link></p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <form className="lg:w-1/2 md:ml-12 2xl:ml-2">
                    <div className="bg-slate-900 rounded-lg flex content-center my-4">
                        <FontAwesomeIcon icon={faCalendarDays} className="h-6 p-4 text-white" />
                        <input type="text" placeholder="Input your email" className="bg-slate-900 text-white rounded-lg w-full border-0 text-lg" />
                    </div>
