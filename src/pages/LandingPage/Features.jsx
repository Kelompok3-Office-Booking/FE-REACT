...
const Feature = ({ imgUrl, title, desc, efect }) => (
    <div className="p-4 mt-2 md:w-1/2 lg:w-1/4 lg:px-8" data-aos={efect} data-aos-offset="500" data-aos-duration="1000" >
        ...
        <div className="bg-slate-900 flex justify-center" id="features">
            <div className="container flex flex-col text-white py-8 md:py-12 lg:py-16 2xl:py-24">
                <div>
                    ...
                    <p className="p-2">4 of the best mainstay features that will make your awesome booking. don't miss it!</p>
                </div>
